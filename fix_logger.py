...
class Logger:
    ...
    def __new__(cls, name='anomaly_detector', log_level=logging.INFO, log_file=None):
        """Singleton pattern com suporte a log_file"""
